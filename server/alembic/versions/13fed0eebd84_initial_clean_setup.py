...
Revision ID: 13fed0eebd84
Revises: 
Create Date: 2025-08-08 15:41:53.145922
...
def upgrade() -> None:
    ...
    sa.Column('guest_names', sa.JSON(), nullable=False),
    ...
    sa.Column('phone', sa.String(), nullable=False),
    sa.Column('payment_method', sa.String(), nullable=False),
    sa.Column('airlines', sa.JSON(), nullable=True),
    sa.Column('total_price', sa.Float(), nullable=True),
    sa.Column('currency', sa.String(), nullable=True),
    sa.Column('booking_token', sa.String(), nullable=True),
    ...
    sa.Column('airline', sa.JSON(), nullable=True),
